...
-- beautiful.xresources.set_dpi(96, 2)
-- beautiful.xresources.set_dpi(192, 1)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, ",",
              function () awful.spawn("/home/artem/Applications/Telegram/Telegram") end,
    ...
    awful.key({ "Mod1", "Control" }, "l",
        function ()
            ...
            -- awful.util.spawn("/usr/bin/xsecurelock_with_params.sh")
            awful.util.spawn("mate-screensaver-command -l")
        end,
    ...
    awful.key({ "Mod1", "Control" }, "b",
        ...
        {description = "hybrid-sleep", group = "global"}),
    -- Sound
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            awful.util.spawn("amixer set PCM 1%+")
        end,
    ...
    awful.key({ }, "XF86AudioMute",
        function ()
            awful.util.spawn("amixer set PCM toggle")
        end,
